...
- Dev Tools, Agent Framework, Design UI, Data AI, Security and more
- Platform filter: Claude Code, Codex, Cursor, OpenCode, Hermes
- Bilingual Chinese + English  |  GitHub: https://github.com/rdone4425/skill
